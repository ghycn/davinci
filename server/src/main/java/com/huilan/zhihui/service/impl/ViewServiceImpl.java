...
import com.huilan.core.utils.MD5Util;
import com.huilan.core.utils.RedisUtils;
...
import com.huilan.zhihui.core.utils.SqlParseUtils;
import com.huilan.zhihui.dao.RelRoleViewMapper;
...
import com.huilan.zhihui.dto.sourceDto.SourceConfig;
            ...
            if (!StringUtils.isEmpty(viewWithSource.getSql())) {
                ...
                if (!CollectionUtils.isEmpty(querySqlList)) {
                    ...
                    if (null != executeParam
                        ...
                        slatBuilder.append(Consts.MINUS);
    ...
    private List<SqlVariable> getAuthVariables(List<RelRoleView> roleViewList, List<SqlVariable> variables) {
        if (!CollectionUtils.isEmpty(variables)) {
            ...
            if (!CollectionUtils.isEmpty(roleViewList)) {
                ...
                List<SqlVariable> authVarables = variables.stream().filter(v -> SqlVariableTypeEnum.AUTHVARE == SqlVariableTypeEnum.typeOf(v.getType())).collect(Collectors.toList());
                            ...
                            if (map.containsKey(v.getName())) {
                                ...
                                if (v.isEnable()) {
                                    if (CollectionUtils.isEmpty(v.getValues())) {
                                        ...
                                        values.add(Constants.N0_AUTH_PERMISSION);
                    ...
                    try {
                        futures.add(executorService.submit(() -> {
                            if (null != sqlVariable) {
                                ...
                                if (null == values) {
                                    vSet.add(Constants.N0_AUTH_PERMISSION);
